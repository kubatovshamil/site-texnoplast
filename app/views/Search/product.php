    ...
    <div class="container">
        <div class="products-items">
            ...
            <div class="col-12 col-md-12 col-sm-12 col-xl-12">
                <h2 style="text-align: center;font-size: 25px;">По вашему запросу найдено:</h2>
            </div>
                ...
                <?php } ?>
              <?php  }else{ ?>
                <h3 style="height: 50vh">По ващему запросу  ничего не найдено:(</h3>
           <?php   } ?>
        </div>
    </div>
</section>
...
<script src="<?=PATH. "/public/js/bucket-add.js"?>"></script>
